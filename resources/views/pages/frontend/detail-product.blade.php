    ...
    <section class="bg-gray-100 py-8 px-4">
        <div class="container mx-auto">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('home') }}" aria-label="current-page">{{ $product->name }}</a>
                </li>
            </ul>
        </div>
    </section>
                    ...
                    <div class="px-3 flex-none" style="width: 320px">
                        <div class="rounded-xl p-4 pb-8 relative bg-white">
                            <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                                <img src="{{ asset('storage/product/gallery/' . $row->product_galleries->first()->image) }}"
